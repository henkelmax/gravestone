...
public class UpdateCheckEvents {
	...
	private static final String UPDATE_CHECK_URL = "http://maxhenkel.de/update/gravestone_1.9.txt";
	...
	private void showUpdateMessage(EntityPlayer player) {
		...
		style.setChatHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new TextComponentString(
